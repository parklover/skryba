    ...
    WorkbookSort.prototype.initiateSortHandler = function (eventArgs) {
        ...
        getData(this.parent, sheet.name + "!" + address, true).then(function (jsonData) {
            ...
            dataManager.executeQuery(query).then(function (e) {
                ...
                var eventArgs = { range: address, sortOptions: args.sortOptions };
 ...
 */
var Ribbon$1 = /** @class */ (function (_super) {
...
var ContextMenu$1 = /** @class */ (function () {
    ...
    ContextMenu$$1.prototype.setHideShowItems = function (items, l10n, layout) {
            ...
            buttons: [{
                    ...
                    click: function () {
                        ...
                        if (!_this.validateError(data, element, errorElem)) {
                            ...
                            _this.parent.sort({ sortDescriptors: data, containsHeader: hasHeader, caseSensitive: caseCheckbox.checked });
                        }
                    }
                }]
        });
...
var dialog = 'dialog';
var beginCompleteEvents = 'beginCompleteEvents';
var fontColor = {
    'Custom': [
