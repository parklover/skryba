...
class TinyMCE_SpellChecker_Engine {
	...
	public static function processRequest($tinymceSpellcheckerConfig) {
	    ...
	    $dupa = new TinyMCE_SpellChecker_EnchantEngine();


		$engine = (new TinyMCE_SpellChecker_Engine)->get($tinymceSpellcheckerConfig["engine"]);
		dump($engine);
//		$engine = new $engine();
        $engine = new TinyMCE_SpellChecker_EnchantEngine();
